...
// 								id='firstName'
// 								errorMessage="First name should be 1-16 characters and shoudn'nt
...
// 								onValueChange={handleInputChange}
// 								id='lastName'
// 								errorMessage="Last Name should be 1-16 characters and shoudn'nt
// include any special character"
// 								pattern='^[A-Za-zА-Яа-я]{1,16}$'
// 							/>
// 							<RegistrationInput
...
// 								onValueChange={handleInputChange}
// 								id='city'
// 								errorMessage="City should be 1-16 characters and shoudn'nt
//  include any special character"
// 								pattern='^[A-Za-zА-Яа-я]{1,16}$'
// 							/>
// 							<RegistrationInput
...
// 								onValueChange={handleInputChange}
// 								id='streetName'
// 								errorMessage="Street name should be 1-16 characters and shoudn'nt
//  include any special character"
// 								pattern='^[A-Za-zА-Яа-я]{1,16}$'
// 							/>
// 							<RegistrationInput
...
// 								type='password'
// 								id='password'
// 								errorMessage='Password should be 8-20 characters and include
...
function RegistrationPage(): React.ReactElement {
	...
	const handleSubmit = (e: FormEvent<HTMLFormElement>): void => {
		e.preventDefault();
		useEffect(() => {
			createCustomer(registrationFormData); // Передаем функцию navigate
		});
	};
					...
					<form className={style.form} onSubmit={handleSubmit}>
						<div className={style.inputs}>
							...
							<RegistrationInput
								...
								onValueChange={handleInputChange}
								id='postalCode'
								errorMessage='The street number must contain only numbers or digits and capital letters.'
								pattern='^(?:\d{5}(?:-\d{4})?|[A-Z]\d[A-Z] \d[A-Z]\d)$'
							/>
							<RegistrationInput
								onValueChange={handleInputChange}
