	...
	return (
		<div className={style.about_us__page}>
					...
					<div className={style.member_container}>
						...
						<div>
							...
							<p className={`${style.text} title_h5`}>
								...
								I realized that there is no future for my profession.
								I started looking for myself and after a while I found myself in programming. And now I really want to develop in this direction,
								I like to learn and cope with difficulties. My goal is to get all possible knowledge in the direction of frontend development and maybe change my life in the future.
							</p>
							<h3 className={`${style.title_h3} title_h3`}>Contribution:</h3>
							<ul className={style.contributions}>
								<li className={style.contributions__item}>
									<p className={`${style.contributions__text} title_h5`}>
										Configured the development environment for the team: Webpack, TypeScript, React, ESLint, Prettier, Husky
									</p>
								</li>
								<li className={style.contributions__item}>
									<p className={`${style.contributions__text} title_h5`}>
								...
								<li className={style.contributions__item}>
									<p className={`${style.contributions__text} title_h5`}>
										Implemented logging and user registration pages with necessary validation of fields, also connected these pages to Commercetools
									</p>
								</li>
								<li className={style.contributions__item}>
									<p className={`${style.contributions__text} title_h5`}>
										Implemented product catalog page, configured filtering, sorting and search for products
									</p>
								</li>
								<li className={style.contributions__item}>
									<p className={`${style.contributions__text} title_h5`}>
										Created an interactive product card page, including adding a modal image zoom with slider
									</p>
								</li>
								<li className={style.contributions__item}>
									<p className={`${style.contributions__text} title_h5`}>
										Implemented a user`s cart page (added the ability to add, remove items, clear the cart, display total cost and user discount)
									</p>
								</li>
								<li className={style.contributions__item}>
									<p className={`${style.contributions__text} title_h5`}>Improved the product page to interact with the cart
									</p>
								</li>
							</ul>
			...
			<div className={style.block_logo}>
				...
				<p className={`${style.color} title_h5`}>The development team worked closely together throughout the project.
					We used the Trello task management system to organize tasks and control the progress of the project.
					We also held regular meetings and code reviews to discuss and improve the code.
				</p>
			</div>
			<p className={`${style.color} title_h5`}>The first sprint involved setting up the repository,
				creating tasks on the board, and customizing the development environment.
				Sergey successfully integrated CommerceTools and developed an API client for the application.
				Marat installed the tools necessary for development, ensuring that the code style complies with the standards.
				Vladimir developed the basic structure of the future application.
			</p>

			<p className={`${style.color} title_h5`}>In the second sprint, Marat focused on implementing the user interface for login and registration,
				while Sergey worked on the backend for authentication and user state management.
				Vladimir successfully implemented routing for site navigation using the React Router library,
				and created the homepage and user page.
			</p>

			<p className={`${style.color} title_h5`}>In the third sprint, Marat took on the development of the product page in the catalog,
				as well as the product detail page and user profile.
				Together with Sergey, integrated the commercetools API to retrieve, display and manage product data.
				Effectively implemented an image slider and interface for editing user profile.
			</p>

			<p className={`${style.color} title_h5`}>In the fourth sprint, Marat and Sergey made improvements to the product page,
				created a shopping cart page and improved the catalog page.
				They added features to manage the cart contents and optimized performance when dealing with a large number of products.
				Vladimir implemented the About us page and refactored the existing code.
			</p>

			<p className={`${style.color} title_h5`}>We followed Agile methodology and used sprints to organize work.
				In each sprint, we set specific goals and benchmarks that allowed us to measure our progress and quality of work.
			</p>
			<div className={style.block_logo}>
				<a
					href='https://rs.school/'
					aria-label='Visit rs.school'
				><ReactSVG src={rsschool} className={style.social__link} />
				</a>
				<p className={`${style.text} title_h5`}>
					We would like to express our sincere gratitude to the entire <a className={style.link} href='https://rs.school/'>RS School</a> team for creating
					an ideal educational place for Front-end developers.
					This is the place where the future of our profession is being built, and we feel proud to be a part of this learning community.
					Thanks to the good organization of the educational process, RS School has become for us not just a school, but a place where we grow as professionals
				</p>
			</div>
		</div>
	);
